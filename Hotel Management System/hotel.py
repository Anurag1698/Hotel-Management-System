...
class HotelManagementSystem:
    def __init__(self, root):
        ...
        cust_btn.grid(row=0, column=1, pady=1)

        room_btn=Button(btn_frame, text="ROOM", command=self.roombooking_details, width=22, font=("times new roman", 14, "bold"), bg="black", fg="gold", bd=0, cursor="hand1")
        room_btn.grid(row=1, column=1, pady=1)
        ...
        logout_btn.grid(row=4, column=1, pady=1)
